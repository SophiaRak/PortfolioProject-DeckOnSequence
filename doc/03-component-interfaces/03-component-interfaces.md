...
//NOTE: CHANGES
// MOST PARAMETERS OF POSITION ARE INDEX + 1 (position 5 means fifth card in deck) FOR USER'S EASE
//I added removeCard(Deck.Card card) since I figured that would be a good method to have
//I also added multiple others
// I don't know exactly what I changed since the most recent version of my proof of concept in addition to those above, I have redone POC a couple times
//not sure how to use @aliases
...
A good thing for this whole project would be an example portfolio project with an example of what each section is supposed to look like. I did this part for part 2 on accident after getting incorrect advice from classmates/sub
