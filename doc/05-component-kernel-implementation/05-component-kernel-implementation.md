...
- [ \ ] I have created a kernel implementation
  ...
  //the instructions allowed for DeckOnSequence
...
my initial idea was to have an extra interface of Deck.Card, but I couldn't find a way to implement add(int, int, int, int) so i changed the representation to sequence(Int[]).
